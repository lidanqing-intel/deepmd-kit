...
# lmp_serial 8 threads
#OMP_NUM_THREADS=12 TF_INTRA_OP_PARALLELISM_THREADS=12 TF_INTER_OP_PARALLELISM_THREADS=1 /usr/bin/time -v numactl -c 0 -m 0 lmp_serial -in in.lammps
...
#
## mpi 12 threads
#OMP_NUM_THREADS=1 TF_INTRA_OP_PARALLELISM_THREADS=1 TF_INTER_OP_PARALLELISM_THREADS=1  mpirun --allow-run-as-root -np 12 lmp_mpi -in in.lammps
#
